...
chain (also known as a K combinator). The object will be the first
argument passed to the callback and is also available as C<$_>. The
...
chained set of object method calls, which is a commonly used pattern.
