...
Mojolicious::Book::Cheatsheet - Reference
...
always contain a class name like C<MyApp>.
...
Run mode for L<Mojolicious> application, should contain a valid mode like
...
Class the L<Mojolicious> renderer should use to find templates in the C<DATA>
section, defaults to C<main>.
