...
A data structure validation library based around
L<JSON Schema|https://json-schema.org>. Use an elegant DSL to generate schemas
to efficiently validate arbitrary Perl data structures.

B<Examples:> The
L<blog|https://github.com/mojolicious/json-validator/tree/master/examples/blog>
application will show you how to properly validate JSON submitted via Ajax
requests to your REST APIs.
