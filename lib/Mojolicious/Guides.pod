...
If you're new to Perl, take a look at
L<Learn Perl in 2 hours 30 minutes|http://qntm.org/files/perl/perl.html> and
the L<Modern Perl|http://onyxneon.com/books/modern_perl/> book, both are
excellent introductions to the language.
