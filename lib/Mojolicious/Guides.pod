...
If you're new to Perl, see L<learn.perl.org|http://learn.perl.org> for
help to get started with the language.

There are also some excellent L<Perl books|http://learn.perl.org/books>
(including some that are freely available online).
