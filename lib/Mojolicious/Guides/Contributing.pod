...
and add new information to the L<Mojolicious wiki|http://github.com/mojolicious/mojo/wiki>.
...
of the community have voiced their opinions and the core team voted for or against a change. To reach the formal voting
stage, a member of the core team needs to call for a vote. You are responsible for securing this vote call as well as
...
advance on the L<mailing list|http://groups.google.com/group/mojolicious> or the official IRC channel C<#mojo> on
