...
For GitHub pull requests, additionally anyone who has had one of their pull
requests previously accepted can call for a vote with a GitHub comment of the
form C<Calling for a vote @mojolicious/core>.
...
Sebastian has veto rights on all decisions.
