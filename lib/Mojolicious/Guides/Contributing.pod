...
Please consider sponsoring the ongoing development of L<Mojolicious>, especially
...
such a grant for a core developer please email C<sri@cpan.org>.
...
toolkit being a unified project. Forks drain resources from the original
project, not just the mindshare but also very valuable bug reports and patches.
Therefore we ask that you to please not publically fork pieces of the
Mojolicious distribution without our consent. As doing so is against our express
wishes, people who engage in unauthorized forking will not be allowed to
participate in community sponsored spaces.
