...
team have cast a vote in favour, or the BDFL overruled the vote. But votes
shouldn't be a race, and we benefit greatly from more data about how popular
features really are. So everyone is encouraged to vote even on already merged
pull requests.
