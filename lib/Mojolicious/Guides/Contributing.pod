...
Votes are public, so non-members can participate as well. Non-members that
regularly have a positive impact on decisions should be considered for core team
membership.
