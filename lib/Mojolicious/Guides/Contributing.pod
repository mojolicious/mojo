...
voting stage, a member of the core team needs to call for a vote. You are
responsible for securing this vote call as well as the required votes. The exact
L</"Voting Rules"> can be found below.
...
now!|https://kiwiirc.com/nextclient/#irc://irc.freenode.net/mojo>), to avoid
unnecessary work and to increase its chances of getting accepted.
...
A feature can be added or modified when at least 3 members of the core team have
cast a vote in favour, or the BDFL overruled the vote.
...
now!|https://kiwiirc.com/nextclient/#irc://irc.freenode.net/mojo>).
