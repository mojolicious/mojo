...
voting stage a pull request needs to be endorsed by a member of the core team.
...
Pull requests on GitHub require at least one approved code review by a member of
the core team before a vote can be called.
