...
For deploying L<Mojolicious> applications on "cloud-native" environments that use L<Envoy|https://www.envoyproxy.io>,
here is a configuration for a basic reverse proxy similar to Apache and Nginx:
