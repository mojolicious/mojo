...
Maybe just the raw unformatted text of the third heading?

  $ mojo get http://mojolicio.us 'h1, h2, h3' 3 raw

You can also extract all text from nested child elements.

  $ mojo get http://mojolicio.us '#mojobar' all

Or all raw unformatted text from the whole document.

  $ mojo get http://mojolicio.us 'html > body' all_raw
