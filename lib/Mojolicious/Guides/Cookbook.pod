...
exception handler attached. And since C<async> functions also capture
exceptions (to turn them into C<rejected> promises), this will make it much
harder for you to ever miss a non-blocking exception again. Even if you forgot
