...
development and in the construction of more advanced web servers, but is solid
and fast enough for small to mid sized applications.
...
There are many more useful methods and attributes in L<Mojo::Command> that you
can use or overload.
