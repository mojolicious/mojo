...
=head2 Apache/Hypnotoad/Proxy

You could set up an Apache VirtualHost for your web app, and proxy all requests
through to it to your Hypnotoad server:
