...
We are optimizing L<Mojolicious> for usability and development speed without
compromises.
...
L<IO::KQueue>, L<IO::Epoll>, L<IO::Socket::SSL>, L<Net::Rendezvous::Publish>
and L<Plack> to provide advanced functionality if they are installed.

=head2 Why reinvent wheels?

Because we can make them rounder.
Components trading flexibility for more usability and development speed are
not as common on CPAN as you might think.
