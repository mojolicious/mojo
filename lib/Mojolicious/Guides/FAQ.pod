...
environment variable to disable certificate validation. And if that's not the
case you might be missing the L<Mozilla::CA> module, which is required by
L<IO::Socket::SSL> to be able to validate certificates.
