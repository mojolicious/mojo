...
C<WebSockets>, we are facing new challenges that go way beyond what modules
like L<LWP> were designed for.
...
frameworks, it actually defines a whole new category.
...
=head2 Why is using Perl 5.8.x such a bad idea?
...
L<Mojolicious> altogether, it would sadly be too much of a competitive
...
Once that's done you can contact the developers via GitHub
