...
then use L<Mojolicious::Controller/"url_for_asset"> or L<Mojolicious::Plugin::TagHelpers/"assset_tag"> to generate URLs
...
With Webpack, for example, this scenario is very easy to set up with a C<webpack.config.js>
L<configuration file|https://webpack.js.org/configuration/>.
...
where your keep your asset sources, such as C<.vue> and C<.jsx> files, is not important, as long as your bundler can
