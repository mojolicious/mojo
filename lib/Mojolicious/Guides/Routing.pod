...
=head2 Embedding Routes (L<Mojolicious::Lite> Controllers)

You can easily embed routes from another application using C<detour>, they
will be treated as if they had been defined in our application.
...
language in normal L<Mojolicious> controllers, without any performance loss
or side effects.
