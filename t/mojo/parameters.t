...
is_deeply $params->multi_param('foo'), ['b;ar'], 'right structure';
is_deeply $params->multi_param('a'), [4, 5], 'right structure';
...
is_deeply $params->multi_param('foo'), [0], 'right value';
...
is_deeply $params->multi_param('foo'), [qw(bar baz)], 'right values';
is $params->param('a'), 'b', 'right value';
is_deeply $params->multi_param('bar'), [qw(bas test)], 'right values';
is_deeply $params->to_hash,
...
is_deeply $params->multi_param('foo'), [qw(ba;r b;az bar baz yada)],
  'right values';
$params = Mojo::Parameters->new(foo => ['ba;r', 'b;az'], bar => 23);
is_deeply $params->to_hash, {foo => ['ba;r', 'b;az'], bar => 23},
  'right structure';
is $params->param('foo'), 'ba;r', 'right value';
is_deeply $params->multi_param('foo'), [qw(ba;r b;az)], 'right values';
$params = Mojo::Parameters->new;
