...
subtest 'Parse Lighttpd CGI environment variables and body (behind reverse proxy)' => sub {
  my $req = Mojo::Message::Request->new;
  $req->parse({
    HTTP_CONTENT_LENGTH  => 11,
    HTTP_DNT             => 1,
...
subtest 'Parse Apache CGI environment variables and body' => sub {
  my $req = Mojo::Message::Request->new;
  $req->parse({
    CONTENT_LENGTH  => 11,
...
subtest 'Parse Apache CGI environment variables with basic authentication' => sub {
  my $req = Mojo::Message::Request->new;
  $req->parse({
    CONTENT_LENGTH           => 11,
...
subtest 'Parse Apache 2.2.11 CGI environment variables and body (trailing slash)' => sub {
  my $req = Mojo::Message::Request->new;
  $req->parse({
    CONTENT_LENGTH  => 11,
    CONTENT_TYPE    => 'application/x-www-form-urlencoded',
...
subtest 'Parse Apache 2.2.11 CGI environment variables and body (no SCRIPT_NAME)' => sub {
  my $req = Mojo::Message::Request->new;
  $req->parse({
    CONTENT_LENGTH  => 11,
    CONTENT_TYPE    => 'application/x-www-form-urlencoded',
...
subtest 'Parse Apache 2.2.11 CGI environment variables and body (no PATH_INFO)' => sub {
  my $req = Mojo::Message::Request->new;
  $req->parse({
    CONTENT_LENGTH  => 11,
    CONTENT_TYPE    => 'application/x-www-form-urlencoded',
...
subtest 'Parse Apache 2.2.9 CGI environment variables (root without PATH_INFO)' => sub {
  my $req = Mojo::Message::Request->new;
  $req->parse({
...
subtest 'Parse Apache mod_fastcgi CGI environment variables (multipart file upload)' => sub {
  my $req = Mojo::Message::Request->new;
  is $req->content->progress, 0, 'right progress';
  $req->parse({
    SCRIPT_NAME       => '',
...
subtest 'Parse IIS 7.5 like CGI environment (HTTPS=off)' => sub {
  my $req = Mojo::Message::Request->new;
  $req->parse({
    CONTENT_LENGTH  => 0,
    PATH_INFO       => '/index.pl/',
