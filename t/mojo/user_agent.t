...
subtest 'Default application' => sub {
...
subtest 'Clean up non-blocking requests' => sub {
...
subtest 'Blocking and non-blocking' => sub {
  my $ua = Mojo::UserAgent->new;
...
subtest 'Promises (shortcut methods)' => sub {
  my $ua = Mojo::UserAgent->new;
  my $result;
...
subtest 'SOCKS proxy request without SOCKS support' => sub {
  my $ua = Mojo::UserAgent->new;
...
subtest 'HTTPS request without TLS support' => sub {
  my $ua = Mojo::UserAgent->new;
...
subtest 'No non-blocking name resolution' => sub {
...
subtest 'No keep-alive' => sub {
  my $ua = Mojo::UserAgent->new;
  my $tx = $ua->get('/one?connection=test');
  ok !$tx->error,      'no error';
...
subtest 'Events' => sub {
  ...
  my $tx = $ua->build_tx(GET => '/does_not_exist');
...
subtest 'Missing Content-Length header' => sub {
  my $ua = Mojo::UserAgent->new;
  my ($finished_req, $finished_tx, $finished_res);
  my $tx = $ua->build_tx(GET => '/no_length');
  ok !$tx->is_finished, 'transaction is not finished';
  $ua->once(
    start => sub {
      my ($ua, $tx) = @_;
...
subtest '204 No Content' => sub {
  my $ua = Mojo::UserAgent->new;
  my $tx = $ua->get('/no_content');
  ok !$tx->error,      'no error';
  ok !$tx->kept_alive, 'kept connection not alive';
  ok $tx->keep_alive, 'keep connection alive';
...
subtest 'Connection was kept alive' => sub {
  my $ua = Mojo::UserAgent->new;
  my $tx = $ua->head('/huge');
  ok !$tx->error,      'no error';
  ok !$tx->kept_alive, 'kept connection not alive';
...
subtest 'Built-in web server times out' => sub {
  my $ua  = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
  my $log = '';
  my $msg = app->log->on(message => sub { $log .= pop });
  my $tx  = $ua->get('/timeout?timeout=0.25');
...
subtest 'Request timeout with keep-alive' => sub {
  my $ua = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
...
subtest 'Response exceeding message size limit' => sub {
  my $ua = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
  $ua->once(
    start => sub {
      my ($ua, $tx) = @_;
...
subtest 'Redirect with connection close' => sub {
  my $ua = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
  my $tx = $ua->max_redirects(3)->get('/redirect_close');
  ok !$tx->error,      'no error';
  ok !$tx->kept_alive, 'kept connection not alive';
  is $tx->res->version, '1.1',    'right version';
  is $tx->res->code,    200,      'right status';
...
subtest 'Compressed response' => sub {
  my $ua = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
  my $tx = $ua->build_tx(GET => '/echo' => 'Hello GZip!');
...
subtest 'Keep-alive timeout in between requests' => sub {
  my $ua     = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
...
subtest 'Stream with drain callback and compressed response' => sub {
  my $ua = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
  my $tx = $ua->build_tx(GET => '/echo');
  my $i  = 0;
  my ($stream, $drain);
  $drain = sub {
    my $content = shift;
...
subtest 'Mixed blocking and non-blocking requests, with custom URL' => sub {
  my $ua = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
  my $tx = $ua->get($ua->server->url);
  ok !$tx->error,      'no error';
  ok !$tx->kept_alive, 'kept connection not alive';
  ok $tx->keep_alive, 'keep connection alive';
  is $tx->res->code, 200,      'right status';
...
subtest 'Simple nested non-blocking requests with timers' => sub {
  my $ua = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
  my @kept_alive;
  $ua->get(
    '/' => sub {
  ...
  Mojo::IOLoop->start;
  is_deeply \@kept_alive, [undef, 1], 'connections kept alive';
};

subtest 'Unexpected 1xx responses' => sub {
  my $ua  = Mojo::UserAgent->new(ioloop => Mojo::IOLoop->singleton);
