...
my $match = $r->match(Mojo::Transaction->new_get('/articles.html'));
...
$match = $r->match(Mojo::Transaction->new_get('/articles/1.html'));
is($match->stack->[0]->{controller}, 'articles');
is($match->stack->[0]->{action},     'load');
is($match->stack->[0]->{id},         '1');
is($match->stack->[0]->{format},     'html');
is($match->url_for,                  '/articles/1.html');
$match = $r->match(Mojo::Transaction->new_get('/articles/1/edit'));
...
$match = $r->match(Mojo::Transaction->new_get('/articles/1/delete'));
is($match->stack->[1]->{controller}, 'articles');
...
# Root
$match = $r->match(Mojo::Transaction->new_get('/'));
...
# Path and captures
$match = $r->match(Mojo::Transaction->new_get('/foo/test/edit'));
...
$match = $r->match(Mojo::Transaction->new_get('/bar/test/delete/22'));
...
$match = $r->match(Mojo::Transaction->new_get('/bar/test/delete'));
is($match->captures->{controller},   'bar');
is($match->captures->{action},       'delete');
...
# Chained routes
$match = $r->match(Mojo::Transaction->new_get('/test2/foo'));
...
$match = $r->match(Mojo::Transaction->new_get('/test2/bar'));
is($match->stack->[0]->{controller}, 'test2');
is($match->stack->[1]->{controller}, 'index');
...
# Waypoints
$match = $r->match(Mojo::Transaction->new_get('/test3'));
...
is($match->stack->[0]->{action},     'l');
is($match->url_for,                  '/test3');
$match = $r->match(Mojo::Transaction->new_get('/test3/edit'));
is($match->stack->[0]->{controller}, 's');
is($match->stack->[0]->{action},     'edit');
...
# Wildcards
$match = $r->match(Mojo::Transaction->new_get('/wildcards/1/hello/there'));
...
$match = $r->match(Mojo::Transaction->new_get('/wildcards/2/hello/there'));
is($match->stack->[0]->{controller}, 'card');
is($match->stack->[0]->{action},     'wild');
is($match->stack->[0]->{wildcard},   'hello/there');
is($match->url_for,                  '/wildcards/2/hello/there');
$match =
  $r->match(Mojo::Transaction->new_get('/wildcards/3/hello/there/foo'));
...
# Format
$match = $r->match(Mojo::Transaction->new_get('/format'));
is($match->stack->[0]->{controller}, 'hello');
is($match->stack->[0]->{action},     'you');
is($match->stack->[0]->{format},     'html');
is($match->url_for,                  '/format.html');
$match = $r->match(Mojo::Transaction->new_get('/format.html'));
is($match->stack->[0]->{controller}, 'hello');
is($match->stack->[0]->{action},     'you');
is($match->stack->[0]->{format},     'html');
is($match->url_for,                  '/format.html');
$match = $r->match(Mojo::Transaction->new_get('/format2.html'));
...
# Request methods
$match = $r->match(Mojo::Transaction->new_get('/method/get.html'));
is($match->stack->[0]->{controller}, 'method');
is($match->stack->[0]->{action},     'get');
is($match->stack->[0]->{format},     'html');
is($match->url_for,                  '/method/get.html');
$match = $r->match(Mojo::Transaction->new_post('/method/post'));
is($match->stack->[0]->{controller}, 'method');
is($match->stack->[0]->{action},     'post');
is($match->stack->[0]->{format},     undef);
is($match->url_for,                  '/method/post');
$match = $r->match(Mojo::Transaction->new_get('/method/post_get'));
is($match->stack->[0]->{controller}, 'method');
is($match->stack->[0]->{action},     'post_get');
is($match->stack->[0]->{format},     undef);
is($match->url_for,                  '/method/post_get');
$match = $r->match(Mojo::Transaction->new_post('/method/post_get'));
is($match->stack->[0]->{controller}, 'method');
is($match->stack->[0]->{action},     'post_get');
is($match->stack->[0]->{format},     undef);
is($match->url_for,                  '/method/post_get');
$match = $r->match(Mojo::Transaction->new_delete('/method/post_get'));
